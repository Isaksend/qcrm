  ...
  <header class="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 shrink-0 relative z-40">
    <div class="flex items-center gap-4 flex-1">
      <h1 class="text-lg font-bold text-gray-900 mr-4 hidden sm:block tracking-tight">
        <router-link to="/" class="hover:text-indigo-600 transition-colors">Tiny CRM</router-link>
      </h1>
      ...
      >
        ...
        <span class="flex-1 text-left hidden sm:inline text-gray-500">Search CRM...</span>
        <span class="flex-1 text-left sm:hidden text-gray-500">Search...</span>
